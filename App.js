  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ marginBottom: 30 }}>
        <Button title="Add Student" onPress={addStudent} color='violet' />
      </View>
      <View style={{ marginBottom: 30 }}>
        <Button title="View" onPress={() => navigation.navigate('Student List')} color='violet' />
      </View>
    </View>
  );
}
...
function StudentLists({ navigation }) {
  ...
  return (
    <View style={{ backgroundColor: 'white' }}>
      <StudentList />
      <View style={{ marginBottom: 30 }}>
        <Button title="Add Student" onPress={() => navigation.goBack()} color='violet' />
      </View>
      <View style={{ marginBottom: 30 }}>
        <Button title="Delete Data" onPress={handleDeleteData} color="green" />
      </View>
    </View>
  );
}
